...
function wpeb_settings_footer() {
    ...
    add_settings_field(
        $id = 'ecode_back_img_desktop',
        $title = __( 'Imagen de fondo ( versión escritorio, tamaño recomendado 1920x620 )', 'ecoded_builder' ),
    ...
    add_settings_field(
        $id = 'ecode_back_img_mobile',
        $title = __( 'Imagen de fondo ( versión móvil, tamaño recomendado 768x620 )', 'ecoded_builder' ),
        $callback = 'filebox_callback',
        $page = 'wpeb_settings_footer',
        $section = 'wpeb_settings_footer_section',
        $args = array( $id, '' )
	...
	register_setting( 'wpeb_settings_footer', 'ecode_back_img_desktop' );
	register_setting( 'wpeb_settings_footer', 'ecode_back_img_mobile' );

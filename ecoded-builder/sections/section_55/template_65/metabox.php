	/* Section_55 template_65 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'content_box_{{page_section_id}}',
		'title'        => __( 'Sección con antetítulo, título, contenido y grupo de imágenes', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
	...
	$cmb->add_field( array(
		...
		'desc' => __( 'Desde aquí se da de alta cada imagen.', 'cmb2' ),
		'type' => 'title',
	) );

    $group_field_id = $cmb->add_field( array(
        'name'    => __( 'Grupo de imágenes', 'cmb2' ),
        'id'      => $prefix . 'cards_group_{{page_section_id}}',
        'type'    => 'group',
        'options' => array(
            'group_title'   => __( 'Imagen {#}', 'cmb2' ),
            'add_button'    => __( 'Añadir otro imagen', 'cmb2' ),

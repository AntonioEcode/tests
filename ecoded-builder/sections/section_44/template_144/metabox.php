	/* Section_44 template_144 */
	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'header_box_{{page_section_id}}',
		'title'        => __( 'Header con H1, subtítulo, un botón e imagen de fondo', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
	...
	$cmb->add_field( array(
        'name' => __( 'Título', 'cmb2' ),
		'desc' => __( 'Si se deja en blanco se utilizará el nombre de la página', 'cmb2' ),

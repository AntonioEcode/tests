...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_44_template_52">
		...
		<div class="section_width">
			<h1 id="ecode_section_44_template_52_title" class="ecode_title"{{builder}} data-edit="ecode_title"{{/builder}}>{{title}}</h1>
			{{php}}<?php
	...
	for (var i = 0; i < array_s44_t52.length; i++) {
		array_articles = array_s44_t52[i].querySelectorAll( '.section_width' );

    /* Section_26 template_31 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'services_box_{{page_section_id}}',
		'title'        => __( 'Sección con títular y elementos con imagen + título + descripción', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
    ...
    $cmb->add_field( array(
        ...
        'id'   => 'slide_image_title_{{page_section_id}}',
        'type' => 'title'
    ) );
    ...
    $cmb->add_field( array(
        ...
        'id'   => 'section_content_{{page_section_id}}',
        'type' => 'title'
    ) );

	$cmb->add_field( array(
        'name' => __( 'Título', 'cmb2' ),
        'desc' => __( 'Titular de la sección', 'cmb2' ),

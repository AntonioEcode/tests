	...
	$cmb = new_cmb2_box( array(
		...
		'title'        => __( 'Listado de trabajos / servicios. Secciones con imagen + subtítulo + título + descripción + botón', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),

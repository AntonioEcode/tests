	/* Section_119 template_184 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'header_box_{{page_section_id}}',
		'title'        => __( 'Sección con título, precio, subtítulo, botón e imagen de fondo', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
	...
	$cmb->add_field( array(
        'name' => __( 'Price', 'cmb2' ),
		'id'   => $prefix . 'price_{{page_section_id}}',
		'type' => 'text_small'
	) );

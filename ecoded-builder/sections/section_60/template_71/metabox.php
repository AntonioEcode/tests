	...
	$cmb->add_field( array(
        'name' => __( 'Parte izquierda de la sección', 'cmb2' ),
	...
	$cmb->add_field( array(
        'name' => __( 'Imagen de fondo de la parte derecha de la sección', 'cmb2' ),
	...
	$cmb->add_field( array(
        'name' => __( 'Contenido de la sección ( parte derecha )', 'cmb2' ),

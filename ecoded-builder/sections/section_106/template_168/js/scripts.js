window.addEventListener( 'ecode_load', function ( event ) {
	...
	if ( document.getElementById( 'ecode_section_106_template_168' ) ) {

		document.getElementById( 'toggle_menu' ).addEventListener( 'click', change_menu_106_168 );

		add_events_click_menu_106_168();
...
function open_menu_106_168() {
	...
	document.getElementById( 'ecode_section_106_template_168' ).classList.add( 'ecode_section_106_template_168_open' );

}

function close_menu_106_168() {
	...
	document.getElementById( 'ecode_section_106_template_168' ).classList.remove( 'ecode_section_106_template_168_open' );

}

function add_events_click_menu_106_168() {

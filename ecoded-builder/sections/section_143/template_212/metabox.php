    /* Section_143 template_212 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'galery_box_{{page_section_id}}',
		'title'        => __( 'Sección con título, subtítulo y galería de imágenes.', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
    ...
    $cmb->add_field( array(
        ...
        'id'   => $prefix . 'content_section_{{page_section_id}}_title_cmb',
        'type' => 'title'
    ) );

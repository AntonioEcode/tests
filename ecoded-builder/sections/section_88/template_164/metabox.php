	/* Section_88 template_164 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'content_box_{{page_section_id}}',
		'title'        => __( 'Sección con título H2, pequeña descripción, datos del autor e imagen', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
	...
	$cmb->add_field( array(
		...
		'id'   => $prefix . 'author_{{page_section_id}}',
		'type' => 'text_medium',
	) );

	$cmb->add_field( array(
		'name' => __( 'Cargo del autor', 'cmb2' ),
		'id'   => $prefix . 'job_position_{{page_section_id}}',
		'type' => 'text_medium',
	) );
	...
	$cmb->add_field( array(
        'name' => __( 'Imagen de la izquierda de las sección', 'cmb2' ),

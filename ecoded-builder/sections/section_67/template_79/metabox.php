	/* Section_67 template_79 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'header_box_{{page_section_id}}',
		'title'        => __( 'Sección listado de 4 artículos', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
	...
	$group_field_id = $cmb->add_field( array(
        ...
        'type' => 'group',
        'desc' => __( 'Selecciona artículos manualmente o déjalo vacío para sacar los 4 últimos artículos automáticamente.', 'cmb2' ),
        'options' => array(

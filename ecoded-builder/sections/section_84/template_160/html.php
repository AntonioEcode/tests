...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_84_template_160">
		<div class="ecode_width_84_160"{{builder}} data-edit="ecode_width_84_160"{{/builder}}>
			{{php}}<?php
	...
	<script type="text/javascript">
		...
		for (var i = 0; i < array_s84_t160.length; i++) {
			array_articles = array_s84_t160[i].querySelectorAll( '.ecode_info, .ecode_figure' );

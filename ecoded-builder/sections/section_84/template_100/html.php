...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_84_template_100"{{builder}} data-edit="ecode_section_84_template_100"{{/builder}}>
		<div class="ecode_width_84_100">
	...
	<script type="text/javascript">
		...
		for (var i = 0; i < array_s84_t100.length; i++) {
			array_articles = array_s84_t100[i].querySelectorAll( '.ecode_info, .ecode_figure' );

...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_84_template_114"{{builder}} data-edit="ecode_section_84_template_114"{{/builder}}>
		<div class="ecode_width_84_114">
	...
	<script type="text/javascript">
		...
		for (var i = 0; i < array_s84_t114.length; i++) {
			array_articles = array_s84_t114[i].querySelectorAll( '.ecode_info, .ecode_figure' );

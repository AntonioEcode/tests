...
// Content form
$form_name = get_post_meta( $current_id, '_{{template_name}}_form_name_{{page_section_id}}', TRUE );
$form_job = get_post_meta( $current_id, '_{{template_name}}_form_job_{{page_section_id}}', TRUE );
$form_tel = get_post_meta( $current_id, '_{{template_name}}_form_tel_{{page_section_id}}', TRUE );
$form_tel_trim  = str_replace( ' ', '', $form_tel );
...
$form_image_alt = !empty( get_post_meta( $form_image_id, '_wp_attachment_image_alt', TRUE ) ) ? get_post_meta( $form_image_id, '_wp_attachment_image_alt', TRUE ) : $form_name;
...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_150_template_238"{{builder}} data-edit="ecode_section_150_template_238::after"{{/builder}}>
		{{php}}<?php
		...
		<div class="ecode_width_150_238">
			...
			<section class="ecode_contact_form">
				<div class="ecode_contact_form_info">
					...
					if( !empty( $form_image_src ) ) {

					?>{{/php}}
					<figure class="ecode_contact_form_figure"{{builder}} data-edit="ecode_contact_form_figure"{{/builder}}>
					...
					?>{{/php}}
					<h3 class="ecode_contact_form_title"{{builder}} data-edit="ecode_contact_form_title"{{/builder}}>{{form_name}}</h3>
					{{php}}<?php
					...
					?>{{/php}}
					<p class="ecode_contact_form_job"{{builder}} data-edit="ecode_contact_form_job"{{/builder}}>{{form_job}}</p>
					{{php}}<?php
					...
					?>{{/php}}
					<a href="tel:{{form_tel_trim}}" class="ecode_contact_form_tel"{{builder}} data-edit="ecode_contact_form_tel"{{/builder}}>{{form_tel}}</a>
					{{php}}<?php

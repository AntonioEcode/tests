...
$cmb->add_field( array(
	'name' => __( 'Nombre', 'cmb2' ),
	'id'   => $prefix . 'form_name_{{page_section_id}}',
	'type' => 'text'
) );

$cmb->add_field( array(
	'name' => __( 'Profesión', 'cmb2' ),
	'id'   => $prefix . 'form_job_{{page_section_id}}',
	'type' => 'text'
) );

$cmb->add_field( array(
	'name' => __( 'Teléfono', 'cmb2' ),
	'id'   => $prefix . 'form_tel_{{page_section_id}}',
	'type' => 'text'
) );

...
function wpeb_settings_footer() {
    ...
    add_settings_field(
        $id = 'ecode_map_image',
        $title = __( 'Imagen del mapa', 'ecoded_builder' ),
	...
	add_settings_field(
        $id = 'ecode_map_link',
        $title = __( 'Enlace de Google Maps', 'ecoded_builder' ),
	...
	register_setting( 'wpeb_settings_footer', 'ecode_map_image' );
	register_setting( 'wpeb_settings_footer', 'ecode_map_link' );

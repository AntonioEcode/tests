window.addEventListener( 'ecode_load', function ( event ) {
	...
	if ( document.getElementsByClassName( 'ecode_width_95_111' ).length != 0 ) {
...
function check_scroll_features_95_111() {
	...
	array_ecode_width_95_111 = document.getElementsByClassName( 'ecode_width_95_111' );

	for ( var i = 0; i < array_ecode_width_95_111.length; i++ ) {

		container_counters = array_ecode_width_95_111[i];
		...
		if ( scrollTop() >= total_scroll ) {
			...
			if ( container_counters.className.indexOf( 'ecode_width_95_111_show' ) == -1 ) {

				container_counters.classList.add( 'ecode_width_95_111_show' );
...
function initialize_counters_95_111( container_counters ) {
	...
	array_counters = container_counters.getElementsByClassName( 'ecode_counter' );

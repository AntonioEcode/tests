	/* Section_109 template_171 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'header_box_{{page_section_id}}',
		'title'        => __( 'Sección con imagen de fondo y un texto con enlace', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
	...
	$cmb->add_field( array(
		...
		'id'   => $prefix . 'url_{{page_section_id}}',
		'type' => 'text_url'
	) );
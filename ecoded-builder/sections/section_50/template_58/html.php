...
$company_name        = get_option( 'ecode_company_name' );
...
$copy_address        = !empty( $copy_address ) ? $copy_address . ', ' : '';
$copy_address        = !empty( $company_postal_code ) ? $copy_address . $company_postal_code : $copy_address;
...
$copy_rrss           = __( 'Síguenos en', 'frontecode' );

?>{{/php}}
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<footer class="ecode_section_50_template_58"{{builder}} data-edit="ecode_section_50_template_58"{{/builder}}>
		<section class="ecode_footer"{{builder}} data-edit="ecode_footer"{{/builder}}>
			<section class="ecode_data">
				<figure class="ecode_logo"{{builder}} data-edit="ecode_logo"{{/builder}}>
					<a href="{{blog_url}}">
				...
				if( !empty( $company_name ) || !empty( $copy_address ) || !empty( $company_city ) || !empty( $company_email ) || !empty( $company_phone ) ) {

					if( !empty( $company_name ) ) {

				?>{{/php}}
				<p class="ecode_data_text"{{builder}} data-edit="ecode_data_text"{{/builder}}>{{company_name}}</p>
				{{php}}<?php
				...
				?>{{/php}}
				<p class="ecode_data_text"{{builder}} data-edit="ecode_data_text"{{/builder}}>{{copy_address}}</p>
				{{php}}<?php
				...
				?>{{/php}}
				<p class="ecode_data_text"{{builder}} data-edit="ecode_data_text"{{/builder}}>{{company_city}}</p>
				{{php}}<?php
				...
				?>{{/php}}
				<p class="ecode_data_text"{{builder}} data-edit="ecode_data_text"{{/builder}}><a href="mailto:{{company_email}}">{{company_email}}</a></p>
				{{php}}<?php
				...
				?>{{/php}}
				<p class="ecode_data_text"{{builder}} data-edit="ecode_data_text"{{/builder}}><a href="tel:{{company_phone_trim}}">{{company_phone}}</a></p>
				{{php}}<?php
				...
				if( !empty( $facebook_url ) || !empty( $twitter_url ) || !empty( $instagram_url ) || !empty( $youtube_url ) ) {

				?>{{/php}}
				<div class="ecode_follow">
					<p class="ecode_follow_text"{{builder}} data-edit="ecode_follow_text"{{/builder}}>{{copy_rrss}}</p>
					{{php}}<?php
		...
		<section class="ecode_copy"{{builder}} data-edit="ecode_copy"{{/builder}}>
			{{php}}<?php

			if( !empty( $footer_info ) ) {

			?>{{/php}}
			<p class="ecode_copy_text"{{builder}} data-edit="ecode_copy_text"{{/builder}}>{{footer_info}}</p>
			{{php}}<?php
		...
		?>{{/php}}
		<div id="ecode_tabbar_whatsapp_50_58" class="ecode_tabbar_whatsapp_50_58">

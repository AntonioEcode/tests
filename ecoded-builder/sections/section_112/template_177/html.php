...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_112_template_177">
		{{php}}<?php
		...
		?>{{/php}}
		<div class="ecode_width_112_177"{{builder}} data-edit="ecode_width_112_177"{{/builder}}>
	...
	<script type="text/javascript">
		...
		for (var i = 0; i < array_s112_t177.length; i++) {
			array_articles = array_s112_t177[i].querySelectorAll( '.ecode_titles' );

...
$logo_id_2  = !empty( get_option( 'wpeb_logo' ) ) ? get_option( 'wpeb_logo' ) : '';
...
if( !empty( $logo_id_2 ) ) {
	...
	if( is_numeric( $logo_id_2 ) ) {
		...
		$logo_alt_2 = get_post_meta( $logo_id_2, '_wp_attachment_image_alt', TRUE );
		$logo_alt_2 = !empty( $logo_alt_2 ) ? $logo_alt_2 : get_bloginfo( 'name' );

	} elseif( is_string( $logo_id_2 ) ) {

		$logo_src_2 = $logo_id_2;
		$logo_alt_2 = get_bloginfo( 'name' );
...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<header id="ecode_section_155_template_252" class="ecode_section_155_template_252">
		<div class="header_width">
			...
			<section id="container_main_menu" class="container_main_menu">
				...
				<figure class="logo_2">
					<a href="{{blog_url}}">
						<img src="{{logo_src_2}}" alt="{{logo_alt_2}}">
					</a>
				</figure>
				<div id="toggle_menu_2" class="toggle_menu_2">
					<span class="top"></span>
					<span class="bottom"></span>
				</div>
				{{php}}<?php
		...
		<div id="ecode_section_155_template_252_layer" class="ecode_section_155_template_252_layer"></div>
	</header>
</section>

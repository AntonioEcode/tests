...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<header id="ecode_section_155_template_250" class="ecode_section_155_template_250">
		...
		<div id="ecode_section_155_template_250_layer" class="ecode_section_155_template_250_layer"></div>
	</header>
</section>

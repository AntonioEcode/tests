...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_53_template_61"{{builder}} data-edit="ecode_section_53_template_61"{{/builder}}>
		{{php}}<?php
	...
	<script type="text/javascript">
		...
		for (var i = 0; i < array_s53_t61.length; i++) {
			array_articles = array_s53_t61[i].querySelectorAll( '.ecode_article' );

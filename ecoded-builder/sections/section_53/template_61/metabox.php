    /* Section_53 template_61 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'awards_box_{{page_section_id}}',
		'title'        => __( 'Sección con logos / imágenes de premios', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),

...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	...
	?>{{/php}}
	<section class="ecode_section_158_template_255">
		<div class="ecode_width_158_255">
			{{php}}<?php
			...
			foreach( $grouped_elements as $element_event_month => $array_events ) {

				$date = new DateTime( $element_event_month );
			...
			<section class="ecode_articles">
				<div class="ecode_articles_info">
					<p class="ecode_articles_info_month"><?php echo $month; ?></p>
					<p class="ecode_articles_info_year"><?php echo $year; ?></p>
				</div>
				<?php
				...
				<article class="ecode_article">
					<div class="ecode_article_info">
						...
						<div class="ecode_article_info_day">
							...
							<span class="ecode_article_info_day_text"><?php echo $day; ?></span>
						</div>
						<?php
						...
						<div class="ecode_article_info_title">
							...
							?>
							<time class="ecode_article_date"><?php echo $element_subtitle; ?></time>
							<?php
							...
							?>
							<p class="ecode_article_additional"><?php echo $element_additional; ?></p>
							<?php
			...
			?>{{/php}}{{builder}}<section class="ecode_articles">
				<div class="ecode_articles_info">
					<p class="ecode_articles_info_month">Abril</p>
				...
				<article class="ecode_article">
					<div class="ecode_article_info">
						<div class="ecode_article_info_day">
							...
							<span class="ecode_article_info_day_text">27</span>
						</div>
						<div class="ecode_article_info_title">
			...
			<section class="ecode_articles">
				<div class="ecode_articles_info">
					<p class="ecode_articles_info_month">Mayo</p>
					<p class="ecode_articles_info_year">2021</p>
				</div>
				<article class="ecode_article">
					<div class="ecode_article_info">
						<div class="ecode_article_info_day">
							...
							<span class="ecode_article_info_day_text">22</span>
						</div>
						<div class="ecode_article_info_title">

    /* Section_158 template_256 */

    $services_{{page_section_id}} = wpeb_get_selector_options_by_template( 'service' );

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'services_box_{{page_section_id}}',
		'title'        => __( 'Listado de conferencias agrupadas por día', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
    ...
    $cmb->add_field( array(
		...
		'desc' => __( 'Desde aquí se pueden dar de alta cada conferencia del listado', 'cmb2' ),
		'type' => 'title',
    ...
    $cmb->add_group_field( $group_field_id, array(
        'name' => __( 'Hora de la conferencia', 'cmb2' ),
        'id'   => 'element_event_hour',
        'type' => 'text_time',
        'time_format' => 'H:i',
        // 'time_format' => 'HH:mm',
    ) );

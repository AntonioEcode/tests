...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	...
	?>{{/php}}
	<section class="ecode_section_145_template_214">
		<div class="ecode_width_145_214">
			<section class="ecode_articles ecode_articles_145_214">
			...
			?>{{/slides_group_loop_start}}
				<article class="ecode_article"{{builder}} data-edit="ecode_article::after"{{/builder}}>
					{{php}}<?php

	/* Section_34 template_41 */
	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'contact_box_{{page_section_id}}',
		'title'        => __( 'Sección con imagen del mapa a ancho completo y enlace', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
	...
	$cmb->add_field( array(
		...
		'id'   => $prefix . 'title_map_img_{{page_section_id}}',
		'type' => 'title'
	) );
	...
	$cmb->add_field( array(
        'name' => __( 'Enlace de la imagen', 'cmb2' ),
		'id'   => $prefix . 'map_url_{{page_section_id}}',
		'type' => 'text_url'
	) );
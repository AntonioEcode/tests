...
$footer_logo_copyright_src = WPEB_PLUGIN_THEME_FRONT . 'img/logo_ecoded_copyright.png';
...
$interesting_links_title        = get_option( 'ecode_footer_interesting_links_title' );
$interesting_link_button_text_1 = get_option( 'ecode_footer_interesting_link_button_text_1' );
$interesting_link_button_url_1  = get_option( 'ecode_footer_interesting_link_button_url_1' );
$interesting_link_button_text_2 = get_option( 'ecode_footer_interesting_link_button_text_2' );
$interesting_link_button_url_2  = get_option( 'ecode_footer_interesting_link_button_url_2' );
...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<footer class="ecode_section_68_template_80"{{builder}} data-edit="ecode_section_68_template_80"{{/builder}}>
		<section class="ecode_footer_width">
			<div class="ecode_footer_container ecode_footer_logo_social"{{builder}} data-edit="ecode_footer_container"{{/builder}}>
				<figure>
					<a href="{{blog_url}}">
			...
			<div class="ecode_footer_container ecode_footer_menu"{{builder}} data-edit="ecode_footer_container"{{/builder}}>
				{{php}}{{menu_nav}}{{/php}}
				{{builder}}<nav class="nav_main_menu">
					<ul class="menu-item ul_main_menu">
						<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item current_page_item">
							<a href="#" data-edit="ecode_footer_menu ul.menu-item li.menu-item a">Recipes</a>
						</li>
						<li class="menu-item menu-item-type-post_type menu-item-object-page">
							<a href="#" data-edit="ecode_footer_menu ul.menu-item li.menu-item a">Places</a>
						</li>
						<li class="menu-item menu-item-type-post_type menu-item-object-page">
							<a href="#" data-edit="ecode_footer_menu ul.menu-item li.menu-item a">Blog</a>
						</li>
						<li class="menu-item menu-item-type-post_type menu-item-object-page">
							<a href="#" data-edit="ecode_footer_menu ul.menu-item li.menu-item a">About</a>
						</li>
						<li class="menu-item menu-item-type-post_type menu-item-object-page">
							<a href="#" data-edit="ecode_footer_menu ul.menu-item li.menu-item a">Contact</a>
						</li>
					</ul>
				</nav>{{/builder}}
			</div>
			...
			?>{{/php}}
			<div class="ecode_footer_container ecode_footer_contact"{{builder}} data-edit="ecode_footer_container"{{/builder}}>
				<p class="ecode_footer_title"{{builder}} data-edit="ecode_footer_title"{{/builder}}>{{copy_contact}}</p>
				{{php}}<?php

				if( !empty( $copy_address ) ) {

				?>{{/php}}
				<p class="ecode_contact_info"{{builder}} data-edit="ecode_contact_info"{{/builder}}>{{copy_address}}</p>
				{{php}}<?php

				}

				if( !empty( $company_phone_trim ) && !empty( $company_phone ) ) {

				?>{{/php}}
				<p class="ecode_contact_info"{{builder}} data-edit="ecode_contact_info"{{/builder}}><a href="tel:{{company_phone_trim}}">{{company_phone}}</a></p>
				{{php}}<?php
				...
				?>{{/php}}
				<p class="ecode_contact_info"{{builder}} data-edit="ecode_contact_info"{{/builder}}><a href="mailto:{{company_email}}">{{company_email}}</a></p>
				{{php}}<?php
			...
			if( !empty( $interesting_links_title )
				&& (
					!empty( $interesting_link_button_text_1 ) && !empty( $interesting_link_button_url_1 )
					|| !empty( $interesting_link_button_text_2 ) && !empty( $interesting_link_button_url_2 )
				)
			) {

			?>{{/php}}
			<div class="ecode_footer_container ecode_footer_buttons"{{builder}} data-edit="ecode_footer_container"{{/builder}}>
				<p class="ecode_footer_title"{{builder}} data-edit="ecode_footer_title"{{/builder}}>{{interesting_links_title}}</p>
				{{php}}<?php

				if( !empty( $interesting_link_button_text_1 ) && !empty( $interesting_link_button_url_1 ) ) {

				?>{{/php}}
				<p><a href="{{interesting_link_button_url_1}}" class="ecode_button button_primary"{{builder}} data-edit="button_primary"{{/builder}}>{{interesting_link_button_text_1}}</a></p>
				{{php}}<?php

				}

				if( !empty( $interesting_link_button_text_2 ) && !empty( $interesting_link_button_url_2 ) ) {

				?>{{/php}}
				<p><a href="{{interesting_link_button_url_2}}" class="ecode_button button_secondary"{{builder}} data-edit="button_secondary"{{/builder}}>{{interesting_link_button_text_2}}</a></p>
				{{php}}<?php
		...
		<section class="ecode_footer_copyright"{{builder}} data-edit="ecode_footer_copyright"{{/builder}}>
			{{php}}<?php

			if( !empty( $footer_info ) ) {

			?>{{/php}}
			<p class="ecode_footer_text"{{builder}} data-edit="ecode_footer_text"{{/builder}}>{{footer_info}}</p>
			{{php}}<?php
		...
		?>{{/php}}
		<div id="ecode_tabbar_whatsapp_68_80" class="ecode_tabbar_whatsapp_68_80">

...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_94_template_110"{{builder}} data-edit="ecode_section_94_template_110"{{/builder}}>
		<div class="ecode_width_94_110">
	...
	<script type="text/javascript">
		...
		for (var i = 0; i < array_s94_t110.length; i++) {
			array_articles = array_s94_t110[i].querySelectorAll( '.ecode_info, .ecode_image' );

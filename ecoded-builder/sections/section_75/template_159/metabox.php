	/* Section_75 template_159 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'contact_box_{{page_section_id}}',
		'title'        => __( 'Sección con información de contacto a la derecha y formulario de contacto a la izquierda', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
	...
	$cmb->add_field( array(
        'name' => __( 'Imagen de fondo de la parte derecha', 'cmb2' ),
	...
	$cmb->add_field( array(
        'name' => __( 'Datos de contacto ( parte derecha )', 'cmb2' ),
	...
	$cmb->add_field( array(
        'name' => __( 'Sección izquierda ( formulario de contacto )', 'cmb2' ),

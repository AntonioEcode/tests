    /* Section_28 template_33 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'partners_slides_box_{{page_section_id}}',
		'title'        => __( 'Sección con logos de partners', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
    ...
    $cmb->add_field( array(
		'name' => __( 'Slider', 'cmb2' ),
		'type' => 'title',
		'id'   => 'partners_slides_group_title_{{page_section_id}}'
	) );
    ...
    $cmb->add_group_field( $group_field_id, array(
        'name' => __( 'Logo del partner', 'cmb2' ),
        'id'   => 'slide_image',
        'type' => 'file'
    ) );

    $cmb->add_group_field( $group_field_id, array(
        'name' => __( 'Enlace del logo', 'cmb2' ),
        'id'   => 'slide_url',
        'type' => 'text_url'
    ) );
    ...
    $cmb->add_group_field( $group_field_id, array(
        'name' => 'Enlace externo',
        'desc' => 'Marcar este check si el enlace es externo a la web para que se abra en una pestaña aparte y añadir nofollow',
        'id'   => 'slide_external_url',
        'type' => 'checkbox',
    ) );
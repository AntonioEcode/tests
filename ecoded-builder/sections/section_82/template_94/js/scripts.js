window.addEventListener( 'ecode_load', function ( event ) {
	...
	if ( document.getElementById( 'ecode_section_82_template_94' ) ) {

		document.getElementById( 'toggle_menu' ).addEventListener( 'click', change_menu_82_94 );

		add_events_click_menu_82_94();
...
function open_menu_82_94() {
	...
	document.getElementById( 'ecode_section_82_template_94' ).classList.add( 'ecode_section_82_template_94_open' );

}

function close_menu_82_94() {
	...
	document.getElementById( 'ecode_section_82_template_94' ).classList.remove( 'ecode_section_82_template_94_open' );

}

function add_events_click_menu_82_94() {

...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	{{php}}<header id="ecode_section_82_template_95" class="ecode_section_82_template_95<?php echo $class_without_info_contact; ?>">{{/php}}
	{{builder}}<header id="ecode_section_82_template_95" class="ecode_section_82_template_95" data-edit="ecode_section_82_template_95">{{/builder}}

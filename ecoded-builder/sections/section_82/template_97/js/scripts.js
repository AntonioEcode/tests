window.addEventListener( 'ecode_load', function ( event ) {
	...
	if ( document.getElementById( 'ecode_section_82_template_97' ) ) {

		document.getElementById( 'toggle_menu' ).addEventListener( 'click', change_menu_82_97 );

		add_events_click_menu_82_97();
...
function open_menu_82_97() {
	...
	document.getElementById( 'ecode_section_82_template_97' ).classList.add( 'ecode_section_82_template_97_open' );

}

function close_menu_82_97() {
	...
	document.getElementById( 'ecode_section_82_template_97' ).classList.remove( 'ecode_section_82_template_97_open' );

}

function add_events_click_menu_82_97() {

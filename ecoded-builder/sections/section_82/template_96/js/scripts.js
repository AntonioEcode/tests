window.addEventListener( 'ecode_load', function ( event ) {
	...
	if ( document.getElementById( 'ecode_section_82_template_96' ) ) {

		document.getElementById( 'toggle_menu' ).addEventListener( 'click', change_menu_82_96 );

		add_events_click_menu_82_96();
...
function open_menu_82_96() {
	...
	document.getElementById( 'ecode_section_82_template_96' ).classList.add( 'ecode_section_82_template_96_open' );

}

function close_menu_82_96() {
	...
	document.getElementById( 'ecode_section_82_template_96' ).classList.remove( 'ecode_section_82_template_96_open' );

}

function add_events_click_menu_82_96() {

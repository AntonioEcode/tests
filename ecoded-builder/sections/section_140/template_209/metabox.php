	/* Section_140 template_209 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'header_box_{{page_section_id}}',
		'title'        => __( 'Sección con imagen de fondo, título, subtítulo, imagen e información de contacto', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
	...
	$cmb->add_field( array(
		...
		'id'   => $prefix . 'section_title2_{{page_section_id}}',
		'type' => 'title'
	) );
	...
	$cmb->add_field( array(
        'name' => __( 'Enlace en el título', 'cmb2' ),
    ...
    $cmb->add_field( array(
        'name' => __( 'Logo', 'cmb2' ),
		'id'   => $prefix . 'logo_{{page_section_id}}',
		'type' => 'file'
	) );
    ...
    $cmb->add_field( array(
        ...
        'id'   => $prefix . 'svg_icon_{{page_section_id}}',
        'type' => 'textarea_code',
    ...
    $cmb->add_field( array(
        'name' => __( 'Información adicional', 'cmb2' ),
		'id'   => $prefix . 'additional_info_{{page_section_id}}',
		'type' => 'text'
	) );

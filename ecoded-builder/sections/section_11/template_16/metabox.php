	/* Section_11 template_16 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'headercta__box_{{page_section_id}}',
		'title'        => __( 'Sección con imagen de fondo, título, descripción, botón y un texto bajo el botón', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
	...
	$cmb->add_field( array(
		...
		'id'   => $prefix . 'button_title_{{page_section_id}}',
		'type' => 'text'
	) );
	...
	$cmb->add_field( array(
        'name' => __( 'Texto debajo del botón', 'cmb2' ),
		'id'   => $prefix . 'text_below_button_{{page_section_id}}',
		'type' => 'text'
	) );

    /* Section_90 template_199 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'galery_box_{{page_section_id}}',
		'title'        => __( 'Sección con subtítulo, galería de imágenes y contenido.', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),

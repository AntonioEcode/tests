window.addEventListener( 'ecode_load', function ( event ) {
	...
	if ( document.getElementsByClassName( 'ecode_gallery_90_199' ).length != 0 ) {

		ecode_initialize_gallery_90_199();
...
/******************************************************************************/
function ecode_initialize_gallery_90_199() {

	array_gallery_90_199 = document.getElementsByClassName( 'ecode_gallery_90_199' );

	for ( var i = 0; i < array_gallery_90_199.length; i++ ) {

		var gallery_90_199 = lightGallery( array_gallery_90_199[i], {
			loop: true,
			download: false,
			closeOnTap: true,

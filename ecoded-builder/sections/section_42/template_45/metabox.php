    /* Section_42 template_45 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'upward_counter_box_{{page_section_id}}',
		'title'        => __( 'Contadores ascendentes informativos con texto antes, después y abajo', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
    ...
    $cmb->add_group_field( $group_field_id, array(
        'name'       => __( 'Texto antes del número animado', 'cmb2' ),
        'desc'       => __( 'Opcional', 'cmb2' ),
        'id'         => 'card_counter_pre_text',
        'type'       => 'text'
    ) );
    ...
    $cmb->add_group_field( $group_field_id, array(
        'name'       => __( 'Texto después del número animado', 'cmb2' ),
        'desc'       => __( 'Opcional', 'cmb2' ),
        'id'         => 'card_counter_post_text',
        'type'       => 'text'
    ) );

    $cmb->add_group_field( $group_field_id, array(
        'name'       => __( 'Texto debajo del número animado', 'cmb2' ),

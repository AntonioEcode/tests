    /* Section_10 template_13 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'partners_slides_box_{{page_section_id}}',
		'title'        => __( 'Sección con título, descripción y sliders con imágenes', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),

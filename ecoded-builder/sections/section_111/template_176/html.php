...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	...
	?>{{/php}}
	<section class="ecode_section_111_template_176"{{builder}} data-edit="ecode_section_111_template_176"{{/builder}}>
		<div class="ecode_width_111_176">
	...
	<script type="text/javascript">
		...
		for (var i = 0; i < array_s111_t176.length; i++) {
			array_articles = array_s111_t176[i].querySelectorAll( '.ecode_article' );

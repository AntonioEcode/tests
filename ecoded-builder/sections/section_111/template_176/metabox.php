 	/* Section_111 template_176 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'content_box_{{page_section_id}}',
		'title'        => __( 'Sección de miembros del equipo con imagen ( alternando su posición entre izquierda y derecha ), cargo, nombre, presentación y premios', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),

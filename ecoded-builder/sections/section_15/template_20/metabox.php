	/* Section_15 template_20 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'title_img_box_{{page_section_id}}',
		'title'        => __( 'Sección con titular, descripción y una imagen', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),

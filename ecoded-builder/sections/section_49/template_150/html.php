...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	...
	?>{{/php}}
	<section class="ecode_section_49_template_150"{{builder}} data-edit="ecode_section_49_template_150"{{/builder}}>
		{{php}}<?php
	...
	<script type="text/javascript">
		...
		for (var i = 0; i < array_s49_t150.length; i++) {
			array_articles = array_s49_t150[i].querySelectorAll( '.ecode_article' );

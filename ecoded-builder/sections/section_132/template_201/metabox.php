	...
	$cmb = new_cmb2_box( array(
		...
		'title'        => __( 'Listado de servicios / trabajos con imagen, título, texto y enlace', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),

...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_115_template_180">
		{{php}}<?php
		...
		?>{{/php}}
		<div class="ecode_width_115_180"{{builder}} data-edit="ecode_width_115_180"{{/builder}}>
	...
	<script type="text/javascript">
		...
		for (var i = 0; i < array_s115_t180.length; i++) {
			array_articles = array_s115_t180[i].querySelectorAll( '.ecode_titles' );

	...
	$cmb = new_cmb2_box( array(
		...
		'title'        => __( 'Sección de contenido para servicios / trabajos', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
    ...
    $cmb->add_field( array(
        ...
        'desc' => __( 'Bloque de contenido que aparece antes de la imagen', 'cmb2' ),
		'type' => 'textarea'
	) );
    ...
    $cmb->add_field( array(
		...
		'id'   => $prefix . 'content_{{page_section_id}}',
        'desc' => __( 'Bloque de contenido que aparece después de la imagen', 'cmb2' ),
		'type' => 'wysiwyg'
	) );
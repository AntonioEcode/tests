    /* Section_89 template_105 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'partners_slides_box_{{page_section_id}}',
		'title'        => __( 'Sección slider de imágenes con enlaces', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
    ...
    $cmb->add_field( array(
		'name' => __( 'Slider', 'cmb2' ),
		'type' => 'title',
		'id'   => $prefix . 'partners_slides_group_title_{{page_section_id}}'
	) );

window.addEventListener( 'ecode_load', function ( event ) {
	...
	if ( document.getElementsByClassName( 'ecode_section_33_template_140' ).length != 0 ) {

		add_click_categories_33_140();

	}

}, false );

function add_click_categories_33_140() {

	array_categories = document.getElementsByClassName( 'ecode_section_33_template_140' )[0].querySelectorAll( 'span.ecode_category' );

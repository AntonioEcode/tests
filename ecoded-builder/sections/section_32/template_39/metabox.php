    /* Section_32 template_39 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'services_box_{{page_section_id}}',
		'title'        => __( 'Sección con dos columnas de contenido', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
    ...
    $cmb->add_field( array(
		...
		'id'      => $prefix . 'section_content_1_{{page_section_id}}',
		'type'    => 'wysiwyg',
		'options' => array( 'wpautop' => true ),
	) );

    $cmb->add_field( array(
		'name'    => __( 'Contenido de la segunda columna', 'cmb2' ),
		'id'      => $prefix . 'section_content_2_{{page_section_id}}',
		'type'    => 'wysiwyg',
		'options' => array( 'wpautop' => true ),
	) );
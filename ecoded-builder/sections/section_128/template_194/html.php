...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_128_template_194"{{builder}} data-edit="ecode_section_128_template_194"{{/builder}}>
		{{php}}<?php

		if( !empty( $data->subtitle ) ) {

		?>{{/php}}
		<p class="ecode_subtitle"{{builder}} data-edit="ecode_subtitle"{{/builder}}>{{title}}</p>
		{{php}}<?php
		...
		?>{{/php}}
		<h2 class="ecode_title"{{builder}} data-edit="ecode_title"{{/builder}}>{{subtitle}}</h2>
		{{php}}<?php

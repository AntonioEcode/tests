...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_45_template_62"{{builder}} data-edit="ecode_section_45_template_62"{{/builder}}>
	...
	<script type="text/javascript">
		...
		for (var i = 0; i < array_s45_t62.length; i++) {
			array_articles = array_s45_t62[i].querySelectorAll( '.ecode_info' );

	/* Section_45 template_147 */

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'header_box_{{page_section_id}}',
		'title'        => __( 'CTA con fondo, antetítulo, título, descripción y botón', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
	...
	$cmb->add_field( array(
        ...
        'id'   => 'section_{{page_section_id}}_title_cmb',
        'type' => 'title'
    ) );

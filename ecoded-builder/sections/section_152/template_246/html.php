...
$button_text_1 = get_post_meta( $current_id, '_{{template_name}}_button_text_1_{{page_section_id}}', TRUE );
$button_url_1  = get_post_meta( $current_id, '_{{template_name}}_button_url_1_{{page_section_id}}', TRUE );

$button_text_2 = get_post_meta( $current_id, '_{{template_name}}_button_text_2_{{page_section_id}}', TRUE );
$button_url_2  = get_post_meta( $current_id, '_{{template_name}}_button_url_2_{{page_section_id}}', TRUE );
...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_152_template_246"{{builder}} data-edit="ecode_section_152_template_246::after"{{/builder}}>
		{{php}}<?php
		...
		<div class="ecode_width_152_246">
			<section class="ecode_info">
				...
				if( ( !empty( $button_text_1 ) && !empty( $button_url_1 ) ) || ( !empty( $button_text_2 ) && !empty( $button_url_2 ) ) ) {

				?>{{/php}}
				<div class="ecode_buttons">
					{{php}}<?php

					if( !empty( $button_text_1 ) && !empty( $button_url_1 ) ) {

					?>{{/php}}
					<a href="{{button_url_1}}" class="ecode_button ecode_button_1"{{builder}} data-edit="ecode_button_1"{{/builder}}>{{button_text_1}}</a>
					{{php}}<?php

					}

					if( !empty( $button_text_2 ) && !empty( $button_url_2 ) ) {

					?>{{/php}}
					<a href="{{button_url_2}}" class="ecode_button ecode_button_2"{{builder}} data-edit="ecode_button_2"{{/builder}}>{{button_text_2}}</a>
					{{php}}<?php

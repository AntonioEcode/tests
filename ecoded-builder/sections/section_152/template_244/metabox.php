...
$cmb->add_field( array(
	...
	'id'   => $prefix . 'button_text_1_{{page_section_id}}',
	'type' => 'text'
) );

$cmb->add_field( array(
	'name' => __( 'Botón 1 - Enlace', 'cmb2' ),
	'id'   => $prefix . 'button_url_1_{{page_section_id}}',
	'type' => 'text_url'
) );

$cmb->add_field( array(
	'name' => __( 'Botón 2 - Texto', 'cmb2' ),
	'id'   => $prefix . 'button_text_2_{{page_section_id}}',
	'type' => 'text'
) );

$cmb->add_field( array(
	'name' => __( 'Botón 2 - Enlace', 'cmb2' ),
	'id'   => $prefix . 'button_url_2_{{page_section_id}}',
	'type' => 'text_url'
) );

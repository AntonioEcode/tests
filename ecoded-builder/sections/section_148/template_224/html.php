...
if( !empty( $slider_conf ) ) {
	...
	$slider_class = 'ecode_articles_148_224 ';

	if( count( $slider_conf ) == 2 ) {

		$slider_class .= 'ecode_articles_148_224_full';
...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	...
	?>{{/php}}
	<section class="ecode_section_148_template_224{{builder}} hover_effect{{/builder}}">
		<div class="ecode_width_148_224">

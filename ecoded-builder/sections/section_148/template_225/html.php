...
if( !empty( $slider_conf ) ) {
	...
	$slider_class = 'ecode_articles_148_225 ';

	if( count( $slider_conf ) == 2 ) {

		$slider_class .= 'ecode_articles_148_225_full';
...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	...
	?>{{/php}}
	<section class="ecode_section_148_template_225{{builder}} hover_effect{{/builder}}">
		<div class="ecode_width_148_225">

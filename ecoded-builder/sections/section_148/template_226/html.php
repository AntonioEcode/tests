...
if( !empty( $slider_conf ) ) {
	...
	$slider_class = 'ecode_articles_148_226 ';

	if( count( $slider_conf ) == 2 ) {

		$slider_class .= 'ecode_articles_148_226_full';
...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	...
	?>{{/php}}
	<section class="ecode_section_148_template_226"{{builder}} data-edit="ecode_section_148_template_226"{{/builder}}>
		<div class="ecode_width_148_226">

    /* Section_139 template_208 */

    $works_{{page_section_id}} = wpeb_get_selector_options_by_template( 'work' );

	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'works_box_{{page_section_id}}',
		'title'        => __( 'Programación de un evento agrupado por días.', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
    ...
    $cmb->add_group_field( $group_field_id, array(
        ...
        'desc' => __( 'Poner lo mismo en cada elemento que se quiera agrupar. Ej 1: Día 1', 'cmb2' ),
        'id'   => 'element_category',
        'type' => 'text_medium'
    ) );

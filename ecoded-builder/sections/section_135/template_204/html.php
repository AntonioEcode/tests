...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_135_template_204"{{builder}} data-edit="ecode_section_135_template_204"{{/builder}}>
		<div class="ecode_width_135_204">
			{{php}}<?php
			...
			<section class="ecode_articles">
				...
				<article class="ecode_article"{{builder}} data-edit-top-right="ecode_article"{{/builder}}>
					{{php}}<?php
					...
					<div class="ecode_article_info">
						...
						?>{{/php}}
						<p class="ecode_article_text"{{builder}} data-edit="ecode_article_text"{{/builder}}>{{card_description}}</p>
						{{php}}<?php

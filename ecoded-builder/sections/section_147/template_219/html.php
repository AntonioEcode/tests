...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_147_template_219">
		{{php}}<?php
		...
		<div class="ecode_width_147_219">
			...
			?>{{/php}}
			<div id="ecode_countdown_147_219" class="ecode_countdown ecode_countdown_147_219" data-countdown="{{countdown_formated}}">
				<div class="ecode_time">
					<p id="ecode_countdown_147_219_days" class="ecode_countdown_time"{{builder}} data-edit="ecode_countdown_time"{{/builder}}>0</p>
					<p class="ecode_countdown_text"{{builder}} data-edit="ecode_countdown_text"{{/builder}}>{{copy_days}}</p>
				</div>
				<span></span>
				<div class="ecode_time">
					<p id="ecode_countdown_147_219_hours" class="ecode_countdown_time"{{builder}} data-edit="ecode_countdown_time"{{/builder}}>0</p>
					<p class="ecode_countdown_text"{{builder}} data-edit="ecode_countdown_text"{{/builder}}>{{copy_hours}}</p>
				</div>
				<span></span>
				<div class="ecode_time">
					<p id="ecode_countdown_147_219_minutes" class="ecode_countdown_time"{{builder}} data-edit="ecode_countdown_time"{{/builder}}>0</p>
					<p class="ecode_countdown_text"{{builder}} data-edit="ecode_countdown_text"{{/builder}}>{{copy_minutes}}</p>
				</div>
				<span></span>
				<div class="ecode_time">
					<p id="ecode_countdown_147_219_seconds" class="ecode_countdown_time"{{builder}} data-edit="ecode_countdown_time"{{/builder}}>0</p>

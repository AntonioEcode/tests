	/* Section_8 template_11 */
	$cmb = new_cmb2_box( array(
		'id'           => $prefix . 'slides_box_{{page_section_id}}',
		'title'        => __( 'Sección con título e imagen de fondo y sliders con imagen + comentario + nombre', 'cmb2' ) . wpeb_get_section_info( $current_page_id, '{{page_section_id}}', '{{section_id}}', '{{template_id}}' ),
    ...
    $cmb->add_field( array(
        ...
        'id'   => $prefix . 'external_url_{{page_section_id}}',
        'type' => 'checkbox',
    ) );

    $cmb->add_field( array(
		'name' => __( 'Slider', 'cmb2' ),
		'desc' => __( 'Desde aquí se puede dar de alta cada slider del listado', 'cmb2' ),
		'type' => 'title',

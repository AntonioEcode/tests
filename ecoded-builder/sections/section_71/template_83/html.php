...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_71_template_83{{builder}} hover_effect{{/builder}}"{{builder}} data-edit="ecode_section_71_template_83"{{/builder}}>
		{{php}}<?php
		...
		<div class="ecode_width_71_83">
			...
			?>{{/php}}
			<section class="ecode_features ecode_features_71_83">
				...
				<article class="ecode_feature"{{builder}} data-edit="ecode_feature"{{/builder}}>
					<p class="ecode_feature_count"{{builder}} data-edit="ecode_feature_count"{{/builder}}>
						<span class="ecode_counter_71_83">{{card_counter_number}}</span>
						{{php}}<?php

						if( !empty( $card_counter_post_text ) ) {

						?>{{/php}}
						<span>{{card_counter_post_text}}</span>
						{{php}}<?php
					...
					?>{{/php}}
					<p class="ecode_feature_text"{{builder}} data-edit="ecode_feature_text"{{/builder}}>{{card_counter_title}}</p>
					{{php}}<?php
	...
	<script type="text/javascript">
		...
		for (var i = 0; i < array_s71_t83.length; i++) {
			array_articles = array_s71_t83[i].querySelectorAll( '.ecode_article' );

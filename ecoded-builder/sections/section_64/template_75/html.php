...
<section id="page_section_{{page_section_id}}"{{builder}} class="page_section"{{/builder}}>
	<section class="ecode_section_64_template_75{{builder}} hover_effect{{/builder}}"{{builder}} data-edit="ecode_section_64_template_75"{{/builder}}>
		<div class="ecode_width_64_75">
			{{php}}<?php
	...
	<script type="text/javascript">
		...
		for (var i = 0; i < array_s64_t75.length; i++) {
			array_articles = array_s64_t75[i].querySelectorAll( '.ecode_list_articles, .ecode_featured_article' );
